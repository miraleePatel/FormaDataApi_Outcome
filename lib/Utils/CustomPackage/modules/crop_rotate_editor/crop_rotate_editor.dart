...
class CropRotateEditorState extends State<CropRotateEditor> {
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, int index) {
                    ...
                    return GestureDetector(
                      ...
                      label:CustomWidgets.text( item.text,color:item.value == _aspectRatio ?
                        Colors.blue : AppColors.whiteColor ,fontSize: 8.sp),
                        icon: SizedBox(
                          height: 38,
                          child: FittedBox(
        ...
        AppBar(
          ...
          leading: GestureDetector(
            ...
            child: Padding(
              ...
              child:CustomWidgets.customIcon(imageName: Assets.iconLeftChevron)
            ),
          ),
          actions: [
            SizedBox(
            ...
            if (constraints.maxWidth >= 300) ...[
              ...
              if (widget.configs.canRotate)
                IconButton(
                  icon: CustomWidgets.customIcon(imageName: Assets.iconRotate),
              ...
              if (widget.configs.canChangeAspectRatio)
                IconButton(
                  ...
                  icon:  CustomWidgets.customIcon(imageName: Assets.iconCropSize),
  ...
  EditorConfig _buildEditorConfig() {
    return EditorConfig(
      ...
      cornerColor:AppColors.skyBlueColor,
