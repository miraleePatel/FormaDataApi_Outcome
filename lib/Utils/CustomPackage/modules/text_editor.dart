...
import 'package:photo_editing_app/Utils/CustomPackage/models/custom_widgets.dart';
            ...
            if (constraints.maxWidth >= 300) ...[
              if (widget.configs.canToggleTextAlign)
                IconButton(
                  ...
                  icon:align == TextAlign.left?
                  CustomWidgets.customIcon(imageName: Assets.iconAlignLeft):
                  align == TextAlign.right?
                  CustomWidgets.customIcon(imageName: Assets.iconAlignRight) :
                  CustomWidgets.customIcon(imageName: Assets.iconAlignCenter),
                ),
              if (widget.configs.canToggleBackgroundMode)
                IconButton(
                  ...
                  icon:  CustomWidgets.customIcon(imageName: Assets.iconLayers),
                ),
              const Spacer(),
              _buildDoneBtn(),
            ] else ...[
