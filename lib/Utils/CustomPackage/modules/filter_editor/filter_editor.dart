...
import 'package:photo_editing_app/Utils/CustomPackage/models/filter_state_history.dart';
          ...
          actions: [
            ...
            GestureDetector(
              ...
              child: Padding(
                ...
                child: Image.asset(Assets.iconDone),
              ),
            )
          ],
        );
...
/*  Column _buildFilterList() {
    var size = const Size(70, 70);
    return Column(
      mainAxisAlignment: MainAxisAlignment.spaceAround,
      children: [
        CarouselSlider.builder(
          ...
          itemBuilder: (context, index, realIndex) {
            return Column(
              ...
              key: ValueKey('Filter-${_filters[index].name}-$index'),
              children: [
                Container(
                  // margin:
                ...
                Expanded(
                  child: CustomWidgets.text(
                    widget.i18n.filterEditor.filters
                        .getFilterI18n(_filters[index].name),
                    maxLine: 2,
                    fontSize: 8.sp,
                  ),
                )
  ...
  void _showInterstitialAd(ColorFilterGenerator filter) {
    ...
    return GestureDetector(
      ...
      child: Column(
        ...
        Container(
          ...
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(7),
            border:  selectedFilter == filter ? Border.all(
        ...
        Expanded(
          child: CustomWidgets.text(widget.i18n.filterEditor.filters.getFilterI18n(name),
              maxLine: 2, fontSize: 6.sp,),
        )
      ]),
    );
  }
