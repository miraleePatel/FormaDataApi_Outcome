...
import 'package:photo_editing_app/Utils/CustomPackage/models/import_export/utils/export_import_enum.dart';
import 'package:photo_editing_app/Utils/CustomPackage/modules/sticker_editor.dart';
...
class ProImageEditorState extends State<ProImageEditor> {
      ...
      builder: (BuildContext context) => AdaptiveDialog(
        ...
        actions: <AdaptiveDialogAction>[
          AdaptiveDialogAction(
            ...
            child:
                Text(widget.configs.i18n.various.closeEditorWarningCancelBtn,style: TextStyle(color: AppColors.skyBlueColor)),
          ),
          AdaptiveDialogAction(
            designMode: widget.configs.designMode,
            onPressed: () {
            ...
            child:
                Text(widget.configs.i18n.various.closeEditorWarningConfirmBtn,style: TextStyle(color: AppColors.skyBlueColor)),
          ),
        ],
      ),
    );
  ...
  Widget? _buildBottomNavBar() {
    var bottomTextStyle =
        const TextStyle(fontSize: 10.0, color: AppColors.skyBlueColor);
                              ...
                              if (widget
                                ...
                                FlatIconTextButton(
                                  ...
                                  label: Text(
                                      ...
                                      style: bottomTextStyle),
                                  icon: CustomWidgets.customIcon(
                                      imageName: Assets.iconCropRotate),
