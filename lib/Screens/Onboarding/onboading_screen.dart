...
import 'onboarding_startnow_screen.dart';
import 'onboarding_welcome_screen.dart';
import 'page/web_analytics_page.dart';
import 'page/web_developer_page.dart';
...
class _SlidingTutorial extends State<SlidingTutorial> {
  ...
  Widget _getPageByIndex(int index) {
    switch (index % 4) {
      ...
      return OnboardingStartNowScreen(index,widget.notifier);
